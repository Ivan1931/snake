...
public class BasiliskTest extends TestCase {
    ...
    private String[] testDataFile13_4 = {"11 13", "47 30", "0", "alive 80 11 48,48 48,46 46,46 46,44 43,44 43,43 47,43 47,44 48,44 48,42 28,42 28,41 49,41 49,49 42,49 42,48 45,48", "alive 51 2 35,32 28,32 28,21 17,21 17,22 19,22 19,37 22,37", "alive 110 7 20,2 15,2 15,4 9,4 9,11 16,11 16,19 17,19 17,11 19,11 19,10 10,10 10,5 25,5 25,20 7,20", "alive 75 1 38,13 38,7 33,7 33,9 34,9 34,8 37,8 37,12 31,12 31,11 35,11 35,10 31,10 31,4 27,4 27,3 16,3 16,4 26,4 26,5 28,5" };
    ...
    public void testDecisionForData13_4() {
        testForState(testDataFile13_4, Direction.WEST);
    }
}
