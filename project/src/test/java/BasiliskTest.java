...
public class BasiliskTest extends TestCase {
    ...
    private String[] testDataFile18_3 = {"32 32", "41 22", "0", "alive 15 9 18,10 28,10 28,9 25,9", "alive 165 5 10,45 27,45 27,44 0,44 0,28 9,28 9,23 28,23 28,44 37,44 37,37 40,37 40,33 41,33 41,37 42,37 42,33 48,33 48,34 44,34 44,36 47,36", "alive 20 2 17,21 17,10 9,10", "alive 20 2 48,32 49,32 49,40 47,40 47,46 46,46 46,45" };
    ...
    public void testDecisionForData13_2() {
        testForState(testDataFile13_2, Direction.EAST);
    }
    ...
    public void testDecisionForData18_3() {
        testForState(testDataFile18_3, Direction.SOUTH);
    }
}
